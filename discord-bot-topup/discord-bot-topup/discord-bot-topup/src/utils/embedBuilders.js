...
class EmbedBuilders {
    ...
    return new EmbedBuilder()
      ...
      .setDescription(`
        ...
        **🎯 บริการที่เปิดให้ใช้งาน:**
        ...
        🎫 **แจ้งปัญหา/สอบถาม**
        • ทีมงานคอยช่วยเหลือ 24/7
        • ระบบ Ticket แบบส่วนตัว
        • แก้ไขปัญหาด่วนและแม่นยำ
      `)
  ...
  static createSupportTicketEmbed(ticketId, user, activeSupportTickets, maxSupportTickets) {
    return new EmbedBuilder()
      .setColor(BrandUtils.brandColors.error)
      .setTitle(`🆘 Support Ticket #${ticketId}`)
      .setDescription(`
        **🤝 ยินดีต้อนรับสู่ระบบช่วยเหลือ NEXArk!**
        
        👋 **สวัสดี ${user.username}!**
        
        ขอบคุณที่ติดต่อทีมงาน เราพร้อมช่วยเหลือคุณ!
        กรุณาอธิบายปัญหาหรือข้อสอบถามของคุณอย่างละเอียด
        
        👤 **Discord ID:** \`${user.id}\`
        📅 **วันที่สร้าง Ticket:** ${Helpers.formatDateTime(new Date())}
        🎫 **Support Tickets ที่เปิดอยู่:** \`${activeSupportTickets.length + 1}/${maxSupportTickets}\`
        📊 **สถานะ:** ${BrandUtils.getStatusIndicator('pending')}
      `)
      .setThumbnail(BrandUtils.brandIcon)
      .addFields(
        {
          name: '📝 วิธีการแจ้งปัญหา',
          value: '**1️⃣ อธิบายปัญหา**\n• บอกรายละเอียดปัญหาให้ชัดเจน\n• ระบุเวลาที่เกิดปัญหา\n• แจ้งขั้นตอนที่ทำก่อนเกิดปัญหา',
          inline: false
        },
        {
          name: '📎 แนบหลักฐาน (หากมี)',
          value: '• ภาพหน้าจอ (Screenshot)\n• วีดีโอการทำงาน\n• ข้อความ Error',
          inline: true
        },
        {
          name: '⏱️ เวลาในการตอบกลับ',
          value: '🟢 ปกติ: 15-30 นาที\n🟡 ช่วงเร่งด่วน: 5-15 นาที\n🔴 ปัญหาระบบ: ทันที',
          inline: true
        },
        {
          name: '🚀 หัวข้อที่สามารถขอความช่วยเหลือได้',
          value: '• 🔗 ปัญหาการเชื่อมต่อบัญชี\n• 💰 ปัญหาการโดเนท/ชำระเงิน\n• 🎮 ปัญหาการรับไอเทมในเกม\n• 🎫 ปัญหา Ticket ที่มีอยู่\n• ❓ คำถามทั่วไปเกี่ยวกับระบบ\n• 🐛 รายงานข้อผิดพลาด (Bug)',
          inline: false
        },
        {
          name: '📞 ช่องทางติดต่ออื่น',
          value: '• Discord DM แอดมิน\n• เซิร์ฟเวอร์หลัก NEXArk\n• เว็บไซต์ชุมชน',
          inline: true
        },
        {
          name: '🕒 เวลาทำงาน',
      ...
      .setFooter({ 
        text: `${BrandUtils.brandFooter} | Support Ticket: ${ticketId} | 💡 ยิ่งให้รายละเอียดมาก ยิ่งช่วยเหลือได้เร็วขึ้น!`,
        iconURL: BrandUtils.brandIcon
      })
      .setTimestamp();
  }
  ...
  static createCloseSupportTicketEmbed(ticketId) {
    return new EmbedBuilder()
      .setColor(BrandUtils.brandColors.warning)
      .setTitle('🔒 ปิด Support Ticket')
      .setDescription(`
        **Support Ticket #${ticketId} ถูกปิดแล้ว**
        
        **Channel นี้จะถูกลบใน 10 วินาที**
        
        หากต้องการความช่วยเหลือเพิ่มเติม สามารถสร้าง Support Ticket ใหม่ได้
      `)
      .setThumbnail(BrandUtils.brandIcon)
      .setFooter({ text: BrandUtils.brandFooter })
      .setTimestamp();
